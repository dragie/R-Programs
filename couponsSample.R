...
setwd("C:\\Users\\vijay\\Documents\\Kaggle\\Coupon Purchase System\\")
...
coupon_list_train = read.csv("C:\\Users\\vijay\\Documents\\Kaggle\\Coupon Purchase System\\coupon_list_train.csv\\coupon_list_train.csv", as.is=T) # Source file the English list is keyed by
trans = data.frame(
